...
<body>
    <div align="center">
        <h2>Spring MVC Form - Insert Form</h2>
        <table border="0" width="90%">
        <form:form action="login" commandName="TreinamentoCommand" class="frmBloqueio">
                <tr>
                    <td align="left" width="20%">Nome: </td>
                    <td align="left" width="40%"><form:input path="nome" size="30"/></td>
                    <td align="left"><form:errors path="nome" cssClass="error"/></td>
                </tr>
                <tr>
                    <td>Telefone: </td>
                    <td><form:input path="telefone" size="30"/></td>
