...
(function (factory) {
    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            var self = $(this), data = self.data('fileinput'), options = typeof option === 'object' && option,
                ...
                lang = options.language || self.data('language') || 'pt-BR', opts;
            if (!data) {
                if (theme) {
                    t = $.fn.fileinputThemes[theme] || {};
                }
                if (lang !== 'pt-BR' && !isEmpty($.fn.fileinputLocales[lang])) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgNo: 'Não',
        msgNoFilesSelected: 'Arquivo inválido',
